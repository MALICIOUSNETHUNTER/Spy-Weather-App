# Comprehensive dictionary of all Indian States and their Administrative Districts
india_states = {
    "Andhra Pradesh": [
        "Ananthapuramu", "Chittoor", "East Godavari", "Guntur", "YSR Kadapa", 
        "Krishna", "Kurnool", "Nellore", "Prakasam", "Srikakulam", 
        "Visakhapatnam", "Vizianagaram", "West Godavari", "Parvathipuram Manyam", 
        "Alluri Sitharama Raju", "Anakapalli", "Kakinada", "Konaseema", 
        "Eluru", "NTR", "Bapatla", "Palnadu", "Nandyal", 
        "Sri Sathya Sai", "Annamayya", "Tirupati"
    ],
    "Arunachal Pradesh": [
        ...
        "Longding", "Kamle", "Pakke Kessang", "Leparada", "Shi Yomi"
    ],
    "Assam": [
        ...
        "South Salmara-Mankachar", "Tinsukia", "Udalguri", "West Karbi Anglong", "Bajali"
    ],
    "Bihar": [
    ...
    "Chhattisgarh": [
        ...
        "Gariaband", "Janijgir-Champa", "Jashpur", "Kabirdham", "Kanker", 
        "Kondagaon", "Korba", "Korea", "Mahasamund", "Mungeli", 
    ...
    "Madhya Pradesh": [
        ...
        "Umaria", "Vidisha", "Mauganj", "Maihar", "Chachoura", "Pandhurna"
    ],
    "Maharashtra": [
    ...
    "Nagaland": [
        ...
        "Zunheboto", "Noklak", "Chümoukedima", "Niuland", "Tseminyü", 
        "Shamator"
    ],
    "Odisha": [
    ...
    "Punjab": [
        ...
        "Shahid Bhagat Singh Nagar", "Sri Muktsar Sahib", "Tarn Taran", "Malerkotla"
    ],
    "Rajasthan": [
        ...
        "Sri Ganganagar", "Tonk", "Udaipur", "Anupgarh", "Balotra", 
        "Beawar", "Deeg", "Didwana-Kuchaman", "Dudu", "Gangapur City", 
        "Kekri", "Kotputli-Behror", "Khairthal-Tijara", "Neem Ka Thana", "Phalodi", 
        "Salumbar", "Sanchore", "Shahpura"
    ],
    "Sikkim": [
        "East Sikkim", "North Sikkim", "South Sikkim", "West Sikkim", "Pakyong", 
        "Soreng"
    ],
    "Tamil Nadu": [
